...
export const OFFICIAL_SOURCES_DATA: DemoItem[] = [
  ...
  },
  {
    ...
    url: 'https://drive.google.com/file/d/1DZcmYw2og-ZO_BcVa7mJjiZbxbSaWgFx/view?usp=sharing',
    source: DemoSource.OFFICIAL,
    status: DemoStatus.LIVE,
    useCase: 'Competition',
    profile: 'General',
  ...
  },
  {
    ...
    url: 'https://drive.google.com/file/d/17NmQqgOmNkDaOZpsgO682DAIL0A7na5b/view?usp=sharing',
    source: DemoSource.OFFICIAL,
    status: DemoStatus.LIVE,
  ...
  },
  {
    ...
    description: 'Learn about the exclusive perks and offers available to Chromebook users.',
    url: 'https://drive.google.com/file/d/1ZDo7XkH_sEnukj58AHaoPA40mLLFEUGT/view?usp=sharing',
    source: DemoSource.OFFICIAL,
    status: DemoStatus.LIVE,
    useCase: 'Perks',
    profile: 'General',
  ...
  {
    id: 'off-gb-meet',
    title: 'Meet Googlebook',
    description: 'Introduction and overview of the new tier of laptops and the value Googlebooks provide.',
    url: 'https://drive.google.com/file/d/1ci2l1Fm9vP7a6h3wMo_iOXk9lvMvRQPc/view?usp=sharing',
    source: DemoSource.OFFICIAL,
    status: DemoStatus.LIVE,
    useCase: 'Device Portfolio',
    profile: 'General',
    type: DemoType.INFOSHEET,
    toolsUsed: ['Googlebook', 'Device Portfolio'],
    tags: ['Googlebook', 'Overview', 'Gemini Intelligence', 'Aluminum', 'Value'],
  },
  {
    id: 'off-gb-sell',
    title: 'How to Sell Googlebook',
    description: 'Retail sales guide for positioning Googlebooks to customers.',
    url: 'https://drive.google.com/file/d/1r_vPBYaSkLfYhn5WXmgNQpDiiFtjEc97/view?usp=sharing',
    source: DemoSource.OFFICIAL,
    status: DemoStatus.LIVE,
    useCase: 'Device Portfolio',
    profile: 'General',
    type: DemoType.INFOSHEET,
    toolsUsed: ['Googlebook', 'Device Portfolio'],
    tags: ['How to Sell', 'Sales Enablement', 'Googlebook', 'Demos', 'Misconceptions', 'Value'],
  },
  {
    id: 'off-gb-intro',
    title: 'Intro to Googlebook eLearning',
    description: 'eModule overview of what Googlebook is, core pillars, Gemini Intelligence features and enhanced Android capabilities.',
    url: 'https://drive.google.com/file/d/1dewLOzpS1Mu6iI13Wg9_pWwIdM9uyb_l/view?usp=sharing',
    source: DemoSource.OFFICIAL,
    status: DemoStatus.LIVE,
    useCase: 'Device Portfolio',
    profile: 'General',
    type: DemoType.INTERACTIVE,
    toolsUsed: ['Googlebook', 'Device Portfolio'],
    tags: ['Googlebook', 'Overview', 'Aluminum', 'Gemini Intelligence', 'Features'],
  },
  {
    id: 'off-sku-lenovo',
    title: 'Lenovo Googlebook 15',
    description: '15-inch flagship Lenovo Googlebook featuring a premium featherweight metal chassis, vibrant touchscreen display, 16GB RAM, all-day battery life, and Gemini Intelligence.',
    url: 'https://drive.google.com/file/d/1c7I7RH7_Nc9kIrHj-RDoirPcDpOVyHjp/view?usp=sharing',
    source: DemoSource.OFFICIAL,
    status: DemoStatus.LIVE,
    useCase: 'Device Portfolio',
    profile: 'General',
    type: DemoType.INFOSHEET,
    toolsUsed: ['Googlebook', 'Googlebook SKUs', 'Device Portfolio'],
    tags: ['Googlebook', 'SKU', 'Lenovo', 'Hardware', '15-inch', 'Gemini'],
  },
  {
    id: 'off-sku-hp',
    title: 'HP Googlebook 14',
    description: '14-inch HP Googlebook engineered with featherweight aluminum styling, backlit keyboard, 16GB RAM, up to 14 hours of battery life, and on-device Gemini capabilities.',
    url: 'https://drive.google.com/file/d/1fechrzXRMabC1WvecvY4yb3NgjGQF4Wv/view?usp=sharing',
    source: DemoSource.OFFICIAL,
    status: DemoStatus.LIVE,
    useCase: 'Device Portfolio',
    profile: 'General',
    type: DemoType.INFOSHEET,
    toolsUsed: ['Googlebook', 'Googlebook SKUs', 'Device Portfolio'],
    tags: ['Googlebook', 'SKU', 'HP', 'Hardware', '14-inch', 'Gemini'],
  },
  {
    id: 'off-sku-dell',
    title: 'Dell XPS Googlebook',
    description: 'Ultra-premium Dell XPS Googlebook combining iconic XPS precision craftsmanship, borderless display, 16GB RAM, and next-gen Gemini Intelligence.',
    url: 'https://drive.google.com/file/d/1n0KuhFDsmIbstubtlfJ3ieLAdHnETxYC/view?usp=sharing',
    source: DemoSource.OFFICIAL,
    status: DemoStatus.LIVE,
    useCase: 'Device Portfolio',
    profile: 'General',
    type: DemoType.INFOSHEET,
    toolsUsed: ['Googlebook', 'Googlebook SKUs', 'Device Portfolio'],
    tags: ['Googlebook', 'SKU', 'Dell', 'XPS', 'Hardware', 'Premium', 'Gemini'],
  },
  {
    id: 'off-sku-asus',
    title: 'ASUS Googlebook 14',
    description: 'Ultra-lightweight 14-inch ASUS Googlebook (1.0kg) crafted with sleek metal styling, 16GB RAM, extended battery life, and native Gemini AI features.',
    url: 'https://drive.google.com/file/d/1aZYcmKZ8EpU24r6vUlkVyLLe9VniHf6u/view?usp=sharing',
    source: DemoSource.OFFICIAL,
    status: DemoStatus.LIVE,
    useCase: 'Device Portfolio',
    profile: 'General',
    type: DemoType.INFOSHEET,
    toolsUsed: ['Googlebook', 'Googlebook SKUs', 'Device Portfolio'],
    tags: ['Googlebook', 'SKU', 'ASUS', 'Hardware', '14-inch', 'Gemini'],
  },
  {
    id: 'off-sku-acer',
    title: 'Acer Googlebook 14',
    description: 'Ultra-slim 14-inch Acer Googlebook (1.1kg) with responsive touchscreen display, 16GB RAM, 14-hour battery, and seamless Android ecosystem integration.',
    url: 'https://drive.google.com/file/d/14Kz6w4iGFAAw4ScDDGtmbuvTcJ3P7vay/view?usp=sharing',
    source: DemoSource.OFFICIAL,
    status: DemoStatus.LIVE,
    useCase: 'Device Portfolio',
    profile: 'General',
    type: DemoType.INFOSHEET,
    toolsUsed: ['Googlebook', 'Googlebook SKUs', 'Device Portfolio'],
    tags: ['Googlebook', 'SKU', 'Acer', 'Hardware', '14-inch', 'Gemini'],
  },
  {
    id: 'off-sku-google-ai-pro',
    title: 'Googlebook: Google AI Pro Offer',
    description: 'Overview of the exclusive Google AI Pro offer and benefits available with Googlebook in the US and Canada.',
    url: 'https://drive.google.com/file/d/1-5sfSjgr1cqtZakNqkENgUf5ynRfE5-K/view?usp=sharing',
    source: DemoSource.OFFICIAL,
    status: DemoStatus.LIVE,
    useCase: 'Device Portfolio',
    profile: 'General',
    type: DemoType.INFOSHEET,
    toolsUsed: ['Googlebook', 'Googlebook SKUs', 'Device Portfolio'],
    tags: ['Googlebook', 'Google AI Pro', 'Offer', 'US', 'CAN', 'Gemini'],
  },
  {
    id: 'off-sales-demo-guide',
    title: 'Sales Demo Guide',
    description: 'Comprehensive presentation deck covering retail sales positioning and live customer demonstration scenarios for Googlebook.',
    url: 'https://docs.google.com/presentation/d/1mICbZoB3Unq5mzHbDIaNabgAaKrDTcfnBUZDNiGBTc0/edit?usp=sharing',
    source: DemoSource.OFFICIAL,
    status: DemoStatus.LIVE,
    useCase: 'Device Portfolio',
    profile: 'General',
    type: DemoType.DECK,
    toolsUsed: ['Googlebook', 'Device Portfolio'],
    tags: ['Googlebook', 'Sales', 'Demos', 'Sales Enablement', 'Android', 'Gemini Intelligence', 'Gemini', 'In-Store'],
  },
  {
    id: 'off-gb-why',
    title: 'Why Googlebook',
    description: 'Video overview highlighting the core benefits, premium featherweight design, and Gemini-powered features of Googlebook.',
    url: 'https://drive.google.com/file/d/1nr5GprGTxKxJB-huEoH2m3kxHNdEHVOZ/view?usp=sharing',
    source: DemoSource.OFFICIAL,
    status: DemoStatus.LIVE,
    useCase: 'Device Portfolio',
    profile: 'General',
    ...
    tags: ['Googlebook', 'Why Googlebook', 'Overview', 'Gemini'],
  },
  {
    id: 'off-gb-everyday',
    title: 'Make the Most of Everyday with Googlebook',
    description: 'Video walkthrough demonstrating how Googlebook seamlessly powers everyday productivity, creativity, and daily routines with Gemini Intelligence.',
    url: 'https://drive.google.com/file/d/1Zx8ls1QCK1pW_7flm9Cb6MuoO2Cg72jg/view?usp=sharing',
    source: DemoSource.OFFICIAL,
    status: DemoStatus.LIVE,
    useCase: 'Device Portfolio',
    profile: 'General',
